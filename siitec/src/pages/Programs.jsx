    ...
    degrees: [
      {
        ...
        // Program Overview
        overview: {
          introText: "Nanotechnology is a crucial new field of science for national development in the era of globalization. The program integrates physics, chemistry, biology, and engineering to create novel materials and devices at the nanoscale.",
          stats: {
            credits: "140 credits",
            duration: "4 years",
        ...
        curriculum: {
          ...
          documents: [
            {
              title: "Bachelor of Engineering Program in Nanomaterials Engineering (Revised Curriculum 2025)",
              url: "https://drive.google.com/file/d/1D3iQ2yQY29jMm5eadVS2-M2LuY34G0Rd/view",
              size: "PDF • 2.4 MB",
              description: "Latest curriculum with updated courses and requirements"
            },
            {
              title: "Bachelor of Engineering Program in Nanomaterials Engineering (Revised Curriculum 2020)",
            ...
            {
              title: "Bachelor of Engineering Program in Nanomaterials Engineering (Revised Curriculum 2016)",
              url: "http://www.cmit.kmitl.ac.th/docs/undergrad/undergrad-2559.pdf",
              size: "PDF",
              description: "Previous curriculum for reference and comparison"
            },
            {
              title: "Bachelor of Engineering Program in Nanomaterials Engineering (Revised Curriculum 2010)",
              url: "http://www.cmit.kmitl.ac.th/docs/undergrad/undergrad-2553.pdf",
              size: "PDF",
              description: "Previous curriculum for reference and comparison"
            },
            {
              title: "The Dual Bachelor's Degree Program includes a Bachelor of Engineering (Nanomaterial Engineering) and a Bachelor of Engineering (Polymer Materials and Engineering) at BUCT.",
        ...
        scholarships: [
          {
            ...
            amount: "$10,000/year",
            description: "For top-performing students entering the program with outstanding academic records."
          },
          {
            name: "Future Innovators Award", 
            amount: "$7,500",
            description: "For students demonstrating exceptional innovation in science and technology."
          }
        ]
      },
...

      {
        ...
        curriculum: {
          ...
          documents: [
            {
              title: "BACHELOR OF ENGINEERING PROGRAM IN SMART MATERIALS TECHNOLOGY (revied 2025)",
              url: "https://drive.google.com/file/d/1SfgnIeuSPm_5-4svjmG1EKpBM-xNUTtG/view",
              size: "PDF • 2.4 MB",
              description: "Latest curriculum with updated courses and requirements"
            },
            {
              title: "BACHELOR OF ENGINEERING PROGRAM IN SMART MATERIALS TECHNOLOGY (revied 2020)",
    ...
    },
    {
...

      {
        ...
        curriculum: {
          ...
          documents: [
            {
              title: "Curriculum document-Dual Bachelor's Degree Program (Revised 2025)",
  ...
  categories: [
    ...
    },
    {
...

      {
        ...
        curriculum: {
          description: "Comprehensive curriculum focusing on manufacturing systems",
          documents: [
            {
              ...
              size: "PDF • 1.8 MB",
              description: "Complete curriculum for Manufacturing System Engineering"
            }
          ]
        },
      ...
      
      {
        ...
        overview: {
          ...
          stats: {
            credits: "54 credits",
            duration: "2 years",
            applicationPeriod: "Multiple intakes",
            tuition: "20,061 THB/semester",
  ...
  degrees: [
    {
      ...
      overview: {
        ...
        stats: {
          credits: "36-48 credits (depending on plan)",
          duration: "2 years full-time",
          applicationPeriod: "January and June intakes",
          tuition: "45,000 THB/semester",
          degreeLevel: "Master of Engineering",
          language: "English/Thai"
        },
        programStructure: "Program structure is classified into 3 plans based on student requirements"
      },
      
      curriculum: {
        description: "Flexible curriculum with three study plans tailored to different career paths",
        plans: [
          {
            name: "Plan A-1",
            ...
            description: "Ideal for students pursuing academic research or doctoral studies"
          },
          {
            name: "Plan A-2", 
            ...
            description: "Balanced approach combining coursework with research experience"
          },
          {
            name: "Plan B",
            ...
            description: "Professional-focused program emphasizing coursework and practical skills"
          }
        ],
        documents: [
          {
            ...
            url: "#",
            size: "PDF • 2.1 MB",
            description: "For students enrolling from Academic Year 2564 (2021) onwards",
          ...
          },
          {
            ...
            url: "#",
            size: "PDF • 1.8 MB", 
            description: "For students enrolling before Academic Year 2564 (2021)",
            note: "Legacy version"
          },
          {
            title: "Curriculum Standard M.Eng. 2563",
            url: "https://www.reg.kmitl.ac.th/curriculum/standard/MEng2563",
            size: "External Link",
  ...
  degrees: [
    {
      ...
      overview: {
        ...
        stats: {
          credits: "48-72 credits (depending on plan and entry level)",
          duration: "3-5 years full-time",
          applicationPeriod: "Rolling admissions",
          tuition: "50,000 THB/semester",
          degreeLevel: "Doctor of Philosophy (International)",
          language: "English"
        },
        programStructure: "Program structure is classified into 3 plans based on student background and requirements"
      },
      
      curriculum: {
        description: "Research-intensive doctoral program with multiple entry paths",
        plans: [
          {
            name: "Plan 1.1",
            type: "Research-based program for Master degree graduates",
            requirements: [
            ...
            target: "Master's degree holders seeking research-focused doctoral training"
          },
          {
            name: "Plan 2.1",
            type: "Coursework and research requirement for Master degree graduates", 
            requirements: [
              "Thesis: 36 credit hours",
            ...
            target: "Master's degree holders preferring balanced coursework-research approach"
          },
          {
            name: "Plan 2.2",
            type: "Coursework and research requirement for Bachelor degree graduates",
            requirements: [
              "Thesis: 48 credit hours",
              "Basic courses in advanced manufacturing system: 9 credit hours",
              "Elective courses: 15 credit hours", 
            ...
            target: "Exceptional Bachelor's degree holders with First Class Honors"
          }
        ],
        documents: [
          {
          ...
          {
            title: "Curriculum Standard Ph.D. 2563",
            url: "https://www.reg.kmitl.ac.th/curriculum/standard/PhD2563",
            size: "External Link",
            description: "Official curriculum standards and requirements for doctoral program"
          }
        ]
      },
